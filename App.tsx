                    ...
                    <div className="p-4 bg-white flex gap-2">
                      ...
                      <div className="relative flex-1">
                        <button
                          ...
                          disabled={upscalingImageId === item.id}
                          className={`w-full flex items-center justify-center p-3 rounded-md transition-all active:scale-95 border ${upscalingImageId === item.id
                          ...
                          title={item.isUpscaled ? `アップスケール済み(${item.upscaleScale || 2}x) - さらにアップスケール可能` : 'AIアップスケール'}
                        >
